...
void newentropy(int x, int y)
	...
	*/
	//int f,g;
	for(int i=0;i<l;i++)
		{d=nex(x,-i)+meret*y; if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) a1.insert(nodes[d]);}
		//cout <<d <<" ";
		d=nex(x,-l+1)+meret*nex(y,-i); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) a2.insert(nodes[d]);}
		//cout <<d <<" ";
		d=nex(x,-i)+meret*nex(y,-l+1); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) a1.insert(nodes[d]);}
		//cout <<d <<" ";
		d=x+meret*nex(y,-i); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) a2.insert(nodes[d]);}
		//cout <<d <<"\n";
		
		d=nex(x,-l-i)+meret*y; if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) b1.insert(nodes[d]);}
		d=nex(x,-2*l+1)+meret*nex(y,-i); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) b2.insert(nodes[d]);}
		d=nex(x,-l-i)+meret*nex(y,-l+1); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) b1.insert(nodes[d]);}
		d=nex(x,-l)+meret*nex(y,-i); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) b2.insert(nodes[d]);}
		
		d=nex(x,-l-i)+meret*nex(y,-l); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) c1.insert(nodes[d]);}
		d=nex(x,-2*l+1)+meret*nex(y,-l-i); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) c2.insert(nodes[d]);}
		d=nex(x,-l-i)+meret*nex(y,-2*l+1); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) c1.insert(nodes[d]);}
		d=nex(x,-l)+meret*nex(y,-l-i); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) c2.insert(nodes[d]);}
		
		d=nex(x,-i)+meret*nex(y,-l); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) d1.insert(nodes[d]);}
		d=nex(x,-l+1)+meret*nex(y,-i-l); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) d2.insert(nodes[d]);}
		d=nex(x,-i)+meret*nex(y,-2*l+1); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) d1.insert(nodes[d]);}
		d=x+meret*nex(y,-l-i); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) d2.insert(nodes[d]);}
		}
	//negyzetek:	
	//a
...
void paraentropy(int x, int y, int db)
	...
	for(int i=0;i<l;i++)
		...
		d=nex(x,n*(l-1)-i)+meret*nex(y,-l+1); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) a1.insert(nodes[d]);}
		...
		d=nex(x,n*(l-1)-l-i)+meret*nex(y,-l+1); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) b1.insert(nodes[d]);}
		//b1.insert(nodes[nex(x,n*(l-1)-l-i)+meret*nex(y,-l+1)]);
		//lnb1 << div(d,meret).rem<< "\11" << div(d,meret).quot << "\n";
		
		d=nex(x,-l-i+n*l)+meret*nex(y,-l); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) c1.insert(nodes[d]);}
		//c1.insert(nodes[nex(x,-l-i+n*l)+meret*nex(y,-l)]);
		//lnc1 << div(d,meret).rem<< "\11" << div(d,meret).quot << "\n";
		d=nex(x,-l-i+n*(2*l-1))+meret*nex(y,-2*l+1); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) c1.insert(nodes[d]);}
		//c1.insert(nodes[nex(x,-l-i+n*(2*l-1))+meret*nex(y,-2*l+1)]);
		//lnc1 << div(d,meret).rem<< "\11" << div(d,meret).quot << "\n";
		
		d=nex(x,-i+n*l)+meret*nex(y,-l); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) d1.insert(nodes[d]);}
		//d1.insert(nodes[nex(x,-i+n*l)+meret*nex(y,-l)]);
		//lnd1 << div(d,meret).rem<< "\11" << div(d,meret).quot << "\n";
		d=nex(x,-i+n*(2*l-1))+meret*nex(y,-2*l+1); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) d1.insert(nodes[d]);}
	...
	for(int i=0;i<n*l;i++)
			...
			d=nex(x,-l+1+i)+meret*nex(y,(int ((double (-i))/a))); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) a2.insert(nodes[d]);}
			//lna << div(d,meret).rem<< "\11" << div(d,meret).quot << "\n";
			d=nex(x,i-n+1)+meret*nex(y,(int ((double (-i))/a))); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) a2.insert(nodes[d]);}
			//lna << div(d,meret).rem<< "\11" << div(d,meret).quot << "\n";
			
			d=nex(x,-2*l+i+1)+meret*nex(y,(int ((double (-i))/a))); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) b2.insert(nodes[d]);}
			//lnb << div(d,meret).rem<< "\11" << div(d,meret).quot << "\n";
			d=nex(x,-l+i-n+1)+meret*nex(y,(int ((double (-i))/a))); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) b2.insert(nodes[d]);}
			//lnb << div(d,meret).rem<< "\11" << div(d,meret).quot << "\n";
			
			d=nex(x,-2*l+i+n*l+1)+meret*nex(y,-l+(int ((double (-i))/a))); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) c2.insert(nodes[d]);}
			//lnc << div(d,meret).rem<< "\11" << div(d,meret).quot << "\n";
			d=nex(x,-l+i+n*l-n+1)+meret*nex(y,-l+(int ((double (-i))/a))); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) c2.insert(nodes[d]);}
			//lnc << div(d,meret).rem<< "\11" << div(d,meret).quot << "\n";
		
			d=nex(x,-l+i+n*l+1)+meret*nex(y,-l+(int ((double (-i))/a))); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) d2.insert(nodes[d]);}
			//lnd << div(d,meret).rem<< "\11" << div(d,meret).quot << "\n";
			d=nex(x,n*l+i-n+1)+meret*nex(y,-l+(int ((double (-i))/a))); if (nodes.find(d)!=nodes.end()) {if (nodes[d]>=0) d2.insert(nodes[d]);}
			//lnd << div(d,meret).rem<< "\11" << div(d,meret).quot << "\n";
			}
	//negyzetek:	
	//a
...
//MTRand mtrand(fend*ido);
	...
	char fs[255];	
	sprintf(fs,"%s/bp_%d_%d_%d_%d.cor",outfile,rid,meret,real,fend);
